...
BEST_PRACTICES_FILES=(core-gtfs routes trips stop_times calendar_dates feed_info faq publishing all-files agency stops fare_attributes fare_rules shapes frequencies transfers loop-routes lasso-routes branches about)
