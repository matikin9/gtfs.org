...
PAGE=src/pages/en/reference/static/recommendation2.md
...
PAGE=src/pages/en/reference/realtime/v2/recommendation2.md
...
PAGE=src/pages/es/reference/realtime/v2/recommendation2.md
...
PAGE=src/pages/en/reference/realtime/v1/recommendation2.md
cp repos/transit/gtfs-realtime/spec/en/reference.md $PAGE
echo -en "---\npath: /reference/realtime/v1/\nlang: en\ntemplate: doc-page\n---\n$(cat $PAGE)" > $PAGE

mkdir -p src/pages/es/reference/realtime/v1
PAGE=src/pages/es/reference/realtime/v1/recommendation2.md
cp repos/transit/gtfs-realtime/spec/es/reference.md $PAGE
...
PAGE=src/pages/en/best-practices/recommendation2.md
rm -f $PAGE
touch $PAGE
echo -en "---\npath: /best-practices/\nlang: en\ntemplate: doc-page\n---\n$(cat $PAGE)" > $PAGE
...
PAGE=src/pages/es/best-practices/recommendation2.md
rm -f $PAGE
touch $PAGE
